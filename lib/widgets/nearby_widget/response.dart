  ...
  NearbyPlacesResponse.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        if(v["formatted_address"]!=null){
          if(!v["name"].toString().toLowerCase().contains("car") && v["formatted_address"].toString().contains(countrySelected)) {
...
class Results {
  ...
  // Results.fromDetailedResult(DetailsResult res) {
  //   return Results(
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    name = json['name'];
    json['formatted_address'] !=null ? formattedAddress = json['formatted_address'] : '';
    json['formattedPhoneNumber'] !=null ? formattedPhoneNumber = json['formattedPhoneNumber'] : '';
    if (json['photos'] != null) {
      photos = <Photos>[];
